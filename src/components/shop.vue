	...
	export default{
		...
		mounted(){
			...
			axios.get("/api/shopone").then(res=>{
				...
				console.log(this.looplist3);
				this.looplist4=res.data.topic.slice(0,4);
				this.looplist9=res.data.category;
				
				// console.log(this.looplist10);
				// this.looplist3=res.data.cellA.img;
				// this.looplist4=res.data.cellB.img;
				// this.looplist2=[this.looplist3,this.looplist4];
